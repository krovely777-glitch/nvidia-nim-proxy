...
app.post('/proxy', async (req, res) => {
    try {
        ...
        const response = await axios.post(NVIDIA_NIM_API_URL, nimRequest, {
            headers: {
                'Authorization': 'Bearer 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',
        ...
        console.error(error);
        res.status(500).json({ error: 'Ошибка при обращении к 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' });
    }
});
